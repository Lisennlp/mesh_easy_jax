...
def load_and_convert_checkpoint(path):
    flax_train_state, flax_params = StreamingCheckpointer.load_trainstate_checkpoint(path)
    if flax_train_state is not None:
        flax_params = flatten_dict(flax_train_state['params']['params'], sep='.')
    torch_params = {}
...
#  --model_size 7b     \
#  --tokenizer_path /nas2/xd/data/models/llama_model/tokenizer.model